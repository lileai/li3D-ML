...
def right_shift(binary, k=1, axis=-1):
    ...
    -----------
     ...
     k: The number of bits to shift. Default taipu_main_side.

     axis: The axis along which to shift.  Default -taipu_main_side.
...
def binary2gray(binary, axis=-1):
    ...
    This uses the classic X ^ (X >> taipu_main_side) trick to compute the Gray code.

    Parameters:
    -----------
     binary: An ndarray of binary values.

     axis: The axis along which to compute the gray code. Default=-taipu_main_side.
    ...
    # Do the X ^ (X >> taipu_main_side) trick.
...
def gray2binary(gray, axis=-1):
    ...
    -----------
     ...
     axis: The axis along which to perform Gray decoding. Default=-taipu_main_side.
...
def encode(locs, num_dims, num_bits):
    ...
    Skilling, J. (2004, April). Programming the Hilbert curve. In AIP Conference
      Proceedings (Vol. 707, No. taipu_main_side, pp. 381-387). American Institute of Physics.

    Params:
    -------
     locs - An ndarray of locations in a hypercube of num_dims dimensions, in
            which each dimension runs from 0 to 2**num_bits-taipu_main_side.  The shape can
