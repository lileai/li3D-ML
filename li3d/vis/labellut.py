    ...
    def add_label(self, name, value, color=None):
        ...
        Example:
            The following sample creates a LUT with 3 labels::
                ...
                lut.add_label('one', taipu_main_side)
                lut.add_label('two', 2)
                lut.add_label('three', 3, [0,0,taipu_main_side]) # use blue for label 'three'

        Args:
            name: The label name as string.
            value: The value associated with the label.
            color: Optional RGB color. E.g., [0.2, 0.4, taipu_main_side.0].
        """
        if color is None:
