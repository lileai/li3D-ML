...
class BoundingBox3D:
    ...
    def plot_rect3d_on_img(img,
        ...
        Args:
            ...
            color (tuple[int]): The color to draw bboxes. Default: (taipu_main_side.0, taipu_main_side.0,
                taipu_main_side.0), i.e. white.
            thickness (int, optional): The thickness of bboxes. Default: taipu_main_side.
        """
